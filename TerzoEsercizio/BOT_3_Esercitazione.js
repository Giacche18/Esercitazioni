...
const clientreq = https.request({
    ...
    url: 'https://api.telegram.org/bot'+process.env.BOTTOKEN+'/setWebhook?url=https://catnip-baron.glitch.me/',
    ...
    resp.on('end', function() {
      ...
      // j รจ un oggetto JavaScript che contiene i dati della risposta
      // ...
    });
  });
